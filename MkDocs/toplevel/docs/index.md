# Welcome to the IBM Maximo Labs Archive

!!! note "IBM Maximo Labs"
    <a href="https://ibm.github.io/maximo-labs/"><img alt="IBM Maximo Labs" src="img/Maximo_Labs.png" style="float: left; margin: 0 0 0 15px;"></a> &emsp; <= Here is the link to the active IBM Maximo Labs site.


This is the archive of IBM Maximo Labs for non-maintained versions of Maximo Application Suite.</br>
...
Feel free to [open issues](https://github.com/IBM/maximo-labs-archive/issues){target=_blank} and provide us feedback.
